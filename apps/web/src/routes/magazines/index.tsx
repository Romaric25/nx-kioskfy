  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        {
          title:
            "Magazines | kioskfy - Votre kiosque numérique de presse africaine",
        },
        { name: "description", content: description },
        { name: "keywords", content: keywords.join(", ") },
        {
          property: "og:title",
          content: "Magazines | kioskfy - Toute la presse africaine",
        },
        { property: "og:description", content: description },
        { property: "og:url", content: `${baseUrl}/magazines` },
        ...
        {
          name: "twitter:title",
          content: "Magazines | kioskfy - Votre kiosque numérique",
        },
        { name: "twitter:description", content: description },
        { name: "robots", content: "index, follow, nocache" },
      ],
      links: [{ rel: "canonical", href: `${baseUrl}/magazines` }],
    };
  },
});
